...
<body>
	<img alt="" src="${pageContext.request.contextPath}/uploads/spur.jpg">
						...
						<div class="card-body">
							...
							<div
								...
								<div class="rotate-img">
									<img src="<c:url value = '/template/web/images/dashboard/home_1.jpg'/>" alt="thumb"
							...
							<div
								...
								<div class="rotate-img">
									<img src="<c:url value = '/template/web/images/dashboard/home_2.jpg'/>" alt="thumb"
										class="img-fluid img-lg" />
								</div>
							</div>
							...
							<div
								...
								<div class="rotate-img">
									<img src="<c:url value = '/template/web/images/dashboard/home_3.jpg'/>" alt="thumb"
										class="img-fluid img-lg" />
								</div>
							</div>
						</div>
						...
						<div class="card-body">
							<div class="row">
								<div class="col-sm-4 grid-margin">
									<div class="position-relative">
										<div class="rotate-img">
											<img src="<c:url value = '/template/web/images/dashboard/home_4.jpg'/>" alt="thumb"
												class="img-fluid" />
										</div>
							...
							<div class="row">
								<div class="col-sm-4 grid-margin">
									<div class="position-relative">
										<div class="rotate-img">
											<img src="<c:url value = '/template/web/images/dashboard/home_5.jpg'/>" alt="thumb"
												class="img-fluid" />
										</div>
										<div class="badge-positioned">
											<span class="badge badge-danger font-weight-bold">Flash
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="position-relative">
										<div class="rotate-img">
											<img src="<c:url value = '/template/web/images/dashboard/home_6.jpg'/>" alt="thumb"
												class="img-fluid" />
										</div>
										<div class="badge-positioned">
											<span class="badge badge-danger font-weight-bold">Flash

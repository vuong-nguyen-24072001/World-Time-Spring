				...
				<div class="d-flex justify-content-between align-items-center">
					...
					<ul class="navbar-top-right-menu">
						...
						<security:authorize access="isAuthenticated()">
							<li class="nav-item"><a href="/user/login" class="nav-link"><%=SecurityUtil.getPrincipal().getFullName()%></a>
							</li>
					...
					<div>
						...
						<div class="navbar-collapse justify-content-center collapse"
							...
							<ul
								...
								<li class="nav-item"><a class="nav-link" href="#">Business</a>
								</li>
								<li class="nav-item"><a class="nav-link" href="#">Sports</a>
								</li>
								<li class="nav-item"><a class="nav-link" href="#">Art</a></li>
								<li class="nav-item"><a class="nav-link" href="#">POLITICS</a>
								</li>
